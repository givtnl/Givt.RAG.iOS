...
------------ | ------------- | ------------- | -------------
*AttachmentsAPI* | [**getAttachmentDetail**](docs/AttachmentsAPI.md#getattachmentdetail) | **GET** /events/{eventId}/participants/{participantId}/attachments | Returns a detail of an single attachment for a participant
...
## Documentation For Models
 ...
 - [AttachmentDetailModel](docs/AttachmentDetailModel.md)
